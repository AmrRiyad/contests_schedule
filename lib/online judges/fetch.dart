...
class CodeforcesContest extends Contest {
  ...
  CodeforcesContest(
      ...
      required String contestDuration,
  ...
  factory CodeforcesContest.fromJson(Map<String, dynamic> json) {
    ...
    double durationSeconds = json['durationSeconds'] ~/ 3600 +
        ((((json['durationSeconds'] / 3600) -
                    (json['durationSeconds'] ~/ 3600)) *
                60) /
            100);
    String formattedDate =
        DateTime.now().add(Duration(seconds: relativeSeconds)).toString();
